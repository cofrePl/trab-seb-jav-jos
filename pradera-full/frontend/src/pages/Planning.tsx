    ...
    <div className="p-6">
      ...
      <div className="mb-6 flex gap-4 border-b">
        <button
          ...
          className={`px-4 py-2 font-medium ${selectedTab === 'tareas'
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${selectedTab === 'hitos'
              ? 'text-blue-600 border-b-2 border-blue-600'
              : 'text-gray-600 hover:text-gray-800'
            }`}
        >
                ...
                {milestones.map(milestone => (
                  <div key={milestone.id} className="bg-white p-4 rounded shadow border-l-4 border-purple-500">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-sm font-medium ${milestone.estado === 'PENDIENTE' ? 'bg-yellow-100 text-yellow-800' :
                          milestone.estado === 'EN_PROGRESO' ? 'bg-blue-100 text-blue-800' :
                            'bg-green-100 text-green-800'
                        }`}>
                        {formatStatus(milestone.estado)}
                      </span>
                    </div>
