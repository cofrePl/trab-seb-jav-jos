    ...
    <div className="p-6">
      ...
      <div className="mb-6 flex gap-4 border-b">
        <button
          ...
          className={`px-4 py-2 font-medium ${selectedTab === 'proyectos'
        ...
        <button
          ...
          className={`px-4 py-2 font-medium ${selectedTab === 'inventario'
              ? 'text-blue-600 border-b-2 border-blue-600'
              : 'text-gray-600 hover:text-gray-800'
            }`}
        >
                  ...
                  {projectsReport.map(project => (
                    <div key={project.id} className="bg-white p-4 rounded shadow border-l-4 border-blue-500">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <span className={`px-2 py-1 rounded text-sm font-medium ${project.estado === 'activo' ? 'bg-green-100 text-green-800' :
                            project.estado === 'pausado' ? 'bg-yellow-100 text-yellow-800' :
                              project.estado === 'en_proceso' ? 'bg-blue-100 text-blue-800' :
                        ...
                        {inventoryMetrics.materials.map((material: any) => (
                          <tr key={material.id} className="hover:bg-gray-100">
                            ...
                            <td className="border p-3">
                              <span className={`px-2 py-1 rounded text-sm font-medium ${material.estado === 'CRITICO' ? 'bg-red-100 text-red-800' :
